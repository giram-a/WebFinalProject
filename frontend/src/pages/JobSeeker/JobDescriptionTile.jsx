...
const JobDescriptionTile = ({activeJob}) => {
    return (
        <>
            <h2 className="text-2xl font-semibold mb-4">{activeJob.title}</h2>
            <p className="text-lg font-medium text-gray-700">{activeJob.company}</p>
            ...
            <div className='flex flex-wrap justify-between'>
                ...
                <p className='italic text-slate-500'>last updated: {activeJob.lastUpdate}</p>
            </div>
        </>
    )
}
